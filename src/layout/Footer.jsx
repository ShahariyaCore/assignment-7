  ...
  return (
    <footer className="bg-green-900 text-white py-10">
      <div className="container mx-auto px-4">
        ...
        {/* Title */}
        <p className="max-w-xl mx-auto text-center text-gray-200 mb-6">
          Your personal shelf of meaningful connections. Browse, tend, and nurture
          the relationships that matter most.
        </p>

        {/* Social Links */}
        <h3 className="text-lg font-semibold text-center mb-3">Social Links</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-300 border-t border-gray-700 pt-4">
          <p className="mb-2 md:mb-0">© 2026 KeenKeeper. All rights reserved.</p>
